...
const FORMAT_REGISTRY: ReadonlyMap<OutputFormat, FormatMetadata> = new Map<
  OutputFormat,
  FormatMetadata
>([
  [
  ...
  [
    ...
    {
      id: 'ksef',
      displayName: 'KSeF FA(3)',
      description:
        'Polish structured e-invoice for the Krajowy System e-Faktur (KSeF 2.0). FA(3) is mandatory since February 2026.',
      countries: ['PL'],
      syntaxType: 'KSeF',
      mimeType: 'application/xml',
      fileExtension: '.xml',
