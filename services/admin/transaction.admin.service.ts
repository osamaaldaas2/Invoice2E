...
class AdminTransactionService {
    ...
    async refundTransaction(
        ...
        let refundResult: { success: boolean; refundId?: string; error?: string; paymentIntentId?: string } = { success: false };
        ...
        // Also update stripe_payment_id if we corrected it from a session ID to payment intent ID
        ...
        if (correctedStripePaymentId) {
            updateData.stripe_payment_id = correctedStripePaymentId;
