...
export class TemplateDBService {
  ...
  async updateTemplate(
    ...
    if (data.sellerAddressStreet !== undefined)
      updateData.seller_address_street = data.sellerAddressStreet;
    if (data.sellerAddressPostalCode !== undefined)
      updateData.seller_address_postal_code = data.sellerAddressPostalCode;
    if (data.sellerAddressCity !== undefined)
      updateData.seller_address_city = data.sellerAddressCity;
    if (data.sellerAddressCountry !== undefined)
      updateData.seller_address_country = data.sellerAddressCountry;
    if (data.sellerContactName !== undefined)
      updateData.seller_contact_name = data.sellerContactName;
    ...
    if (data.buyerAddressStreet !== undefined)
      updateData.buyer_address_street = data.buyerAddressStreet;
    if (data.buyerAddressPostalCode !== undefined)
      updateData.buyer_address_postal_code = data.buyerAddressPostalCode;
    if (data.buyerAddressCity !== undefined) updateData.buyer_address_city = data.buyerAddressCity;
    if (data.buyerAddressCountry !== undefined)
      updateData.buyer_address_country = data.buyerAddressCountry;
    ...
    if (data.paymentInstructions !== undefined)
      updateData.payment_instructions = data.paymentInstructions;
  ...
  async setDefaultTemplate(userId: string, templateId: string): Promise<void> {
    ...
    await supabase.from('user_templates').update({ is_default: false }).eq('user_id', userId);
