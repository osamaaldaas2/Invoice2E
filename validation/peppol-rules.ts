...
const VALID_ENDPOINT_SCHEME_IDS = new Set([
  ...
  '0088', '0096', '0097', '0106', '0130', '0135', '0142', '0147', '0151',
  '0170', '0183', '0184', '0188', '0190', '0191', '0192', '0193', '0194',
  '0195', '0196', '0198', '0199', '0200', '0201', '0202', '0203', '0204',
  '0208', '0209', '0210', '0211', '0212', '0213', '0215', '0216', '9901',
...
const PEPPOL_PAYMENT_MEANS_CODES = new Set([
  ...
  '66', '67', '68', '69', '70', '74', '75', '76', '77', '78', '91', '92',
  '93', '94', '95', '96', '97', 'ZZZ',
]);
...
export function validatePeppolRules(data: CanonicalInvoice): ValidationError[] {
  ...
  const countryChecks: Array<{ value?: string; field: string; label: string }> = [
    { value: data.seller?.countryCode ?? undefined, field: 'invoice.seller.countryCode', label: 'Seller' },
    { value: data.buyer?.countryCode ?? undefined, field: 'invoice.buyer.countryCode', label: 'Buyer' },
  ];
    ...
    if (code && !ISO_COUNTRY_CODE_PATTERN.test(code)) {
      errors.push(
        createError(
          ...
          { actual: code, suggestion: 'Use a 2-letter uppercase country code (e.g. "DE", "SE", "NO")' }
        )
      );
    }
  }
