-- Fix: credit_transactions.source too narrow for idempotency keys used as reason
ALTER TABLE credit_transactions ALTER COLUMN source TYPE VARCHAR(255);
-- Also widen safe_deduct_credits p_reason to match
