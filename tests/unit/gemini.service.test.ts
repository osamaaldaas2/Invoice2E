    ...
    describe('validateExtractedData', () => {
        it('should accept valid data with all required fields', () => {
            const validData: ExtractedInvoiceData = {
                ...
                supplierAddress: '456 Supplier Ave',
        ...
        it('should reject data without total amount', () => {
            const invalidData = {
                items: [{ description: 'Item', quantity: 1, unitPrice: 100, totalPrice: 100 }],
                totalAmount: 0,
        ...
        it('should reject items without description', () => {
            const invalidData = {
                items: [{ description: '', quantity: 1, unitPrice: 100, totalPrice: 100 }],
                totalAmount: 100,
            } as ExtractedInvoiceData;
        ...
        it('should reject items without quantity', () => {
            const invalidData = {
                items: [{ description: 'Item', quantity: 0, unitPrice: 100, totalPrice: 100 }],
                totalAmount: 100,
            } as ExtractedInvoiceData;
        ...
        it('should reject items without unit price', () => {
            const invalidData = {
                items: [{ description: 'Item', quantity: 1, unitPrice: 0, totalPrice: 100 }],
                totalAmount: 100,
            } as ExtractedInvoiceData;
