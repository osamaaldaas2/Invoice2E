...
const config = FORMAT_LANDING_CONFIGS.find((c) => c.slug === 'pdf-to-cius-ro')!;
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: '/pdf-to-cius-ro' },
    openGraph: {
      title: t('meta.title'),
      description: t('meta.desc'),
      type: 'website',
      url: 'https://www.invoice2e.eu/pdf-to-cius-ro',
    },
  };
}

export default function PdfToCiusRoPage() {
