...
export async function GET(
    ...
    try {
        ...
        const { items, total } = await adminUserService.getUserConversions(userId, page, limit);
        ...
        return handleApiError(error, 'Admin user conversions error', {
            includeSuccess: true,
            message: 'Failed to fetch user conversions',
