...
export async function GET(
    ...
    try {
        ...
        const { items, total } = await adminUserService.getUserCreditTransactions(userId, page, limit);
        ...
        return handleApiError(error, 'Admin user credit transactions error', {
            includeSuccess: true,
            message: 'Failed to fetch user credit transactions',
