        ...
        return (
            <div className="flex items-center justify-center min-h-screen">
                <div className="text-center">
                    ...
                    <p className="text-faded">{t('loading')}</p>
                </div>
            </div>
        );
    }
        ...
        return (
            <div className="flex items-center justify-center min-h-screen">
                <div className="text-center max-w-md glass-card p-8">
                    ...
                    <h1 className="text-2xl font-bold text-white font-display mb-2">{t('errorTitle')}</h1>
    ...
    return (
        <ErrorBoundary>
            ...
            <div className="container mx-auto px-4 pt-6 flex items-center justify-between min-w-0">
                <span className="text-faded font-medium">{t('reviewingInvoice')}</span>
                <button
                    onClick={() => {
                    ...
                    className="px-4 py-2 border border-white/15 rounded-full bg-white/5 hover:bg-white/10 text-white"
                >
                    {t('cancel')}
                </button>
            </div>
                ...
                <div className="container mx-auto px-4 py-4">
                    <div className="flex items-center justify-center gap-2 sm:gap-4">
                        ...
                        <div className="flex items-center gap-1 sm:gap-2">
                            ...
                            <span className="text-sky-200 font-medium text-xs sm:text-sm hidden sm:inline">{t('stepReview')}</span>
                        </div>
                        ...
                        <div className="flex items-center gap-1 sm:gap-2">
                            ...
                            <span className="text-faded text-xs sm:text-sm hidden sm:inline">{t('stepConvert')}</span>
                        </div>
                        <div className="h-px w-6 sm:w-12 bg-white/10" />
                        <div className="flex items-center gap-1 sm:gap-2">
                            <div className="w-7 h-7 sm:w-8 sm:h-8 bg-white/10 rounded-full flex items-center justify-center text-faded text-sm">
                            ...
                            <span className="text-faded text-xs sm:text-sm hidden sm:inline">{t('stepDownload')}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <main className="container mx-auto px-4 py-8">
                <div className="max-w-4xl mx-auto">
                    <div className="mb-8">
                        <h1 className="text-2xl md:text-3xl font-bold text-white font-display mb-2">{t('title')}</h1>
