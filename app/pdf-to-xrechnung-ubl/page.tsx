...
const config = FORMAT_LANDING_CONFIGS.find((c) => c.slug === 'pdf-to-xrechnung-ubl')!;
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: '/pdf-to-xrechnung-ubl' },
    openGraph: {
      title: t('meta.title'),
      description: t('meta.desc'),
      type: 'website',
      url: 'https://www.invoice2e.eu/pdf-to-xrechnung-ubl',
    },
  };
}

export default function PdfToXRechnungUblPage() {
