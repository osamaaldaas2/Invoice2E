...
const config = FORMAT_LANDING_CONFIGS.find((c) => c.slug === 'pdf-to-zugferd')!;
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: '/pdf-to-zugferd' },
    openGraph: {
      title: t('meta.title'),
      description: t('meta.desc'),
      type: 'website',
      url: 'https://www.invoice2e.eu/pdf-to-zugferd',
    },
  };
}

export default function PdfToZugferdPage() {
