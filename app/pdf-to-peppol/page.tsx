...
const config = FORMAT_LANDING_CONFIGS.find((c) => c.slug === 'pdf-to-peppol')!;
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: '/pdf-to-peppol' },
    openGraph: {
      title: t('meta.title'),
      description: t('meta.desc'),
      type: 'website',
      url: 'https://www.invoice2e.eu/pdf-to-peppol',
    },
  };
}

export default function PdfToPeppolPage() {
