...
const config = FORMAT_LANDING_CONFIGS.find((c) => c.slug === 'pdf-to-nlcius')!;
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: '/pdf-to-nlcius' },
    openGraph: {
      title: t('meta.title'),
      description: t('meta.desc'),
      type: 'website',
      url: 'https://www.invoice2e.eu/pdf-to-nlcius',
    },
  };
}

export default function PdfToNlciusPage() {
